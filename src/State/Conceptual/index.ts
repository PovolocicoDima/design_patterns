...
class ClientContext {
    ...
    public transitionTo(state: State): void {
        console.log(`ClientContext: Transition to ${(<any>state).constructor.name}.`);
        this.state = state;
 ...
 * Клиентский код.
 */
const clientContext = new ClientContext(new ConcreteStateA());
clientContext.request1();
clientContext.request2();
